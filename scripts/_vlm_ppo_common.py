...
def resolve_wandb_config(config: dict[str, Any], args: argparse.Namespace, log_dir: Path) -> dict[str, Any]:
    ...
    wandb_cfg.setdefault("log_train_maps", True)
    wandb_cfg.setdefault("train_map_env_id", 0)
    wandb_cfg.setdefault("train_map_image_size", 512)
    wandb_cfg.setdefault("train_map_interval", 10)
