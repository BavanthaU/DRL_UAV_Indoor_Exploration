...
class RLDiscreteLimited5ValuesSetpointController():
    ...
    def update_ref(self, dt: float, action: torch.Tensor):
        """Method that updates the references for the controller to track. The action from the RL algorithm lives in a 1D discrete action space, with 5 possible values (0-4). 
