"""
NOTE: The following code is adapted from Stable-Baselines3 (SB3). 
Only modifications made: changed logging behavior and logging values. 
All other parts remain unchanged from the original source.
"""
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def dump_logs(self) -> None:
        ...
        if len(self.ep_info_buffer) > 0 and len(self.ep_info_buffer[0]) > 0:
            ...
            self.logger.record("rollout/occupied_cells_mean", safe_mean([ep_info["occupied_cells"] for ep_info in self.ep_info_buffer]))
